...
```
cd existing_repo
git remote add origin https://gitlab.privy.id/qa-engineer/revamp-webapp/frontend/cypress-automation-web-privy-revamp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.privy.id/qa-engineer/revamp-webapp/frontend/cypress-automation-web-privy-revamp/-/settings/integrations)
...
```
cd existing_repo
git remote add origin https://gitlab.com/dikurrrr/cypresses_typescript.git
git branch -M main
git push -uf origin main
```
...
- [ ] [Set up project integrations](https://gitlab.com/dikurrrr/cypresses_typescript/-/settings/integrations)
